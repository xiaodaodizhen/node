...
EventEimtter.prototype.getMaxListeners = function () {
  return this._count ? this._count : EventEimtter.addListener.defaultMaxListeners;
}
...
EventEimtter.prototype.on = function (type, cb, flag) {
  ...
  // type 如果不是newListener ，就应该让newListener执行以下。
  if (type !== 'newListener') {
    this._events['newListener'] && this._events['newListener'].forEach(e => {
      e(type);
    });
  }
